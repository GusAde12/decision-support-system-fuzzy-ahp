...
<div class="panel panel-default">
    ...
    <div class="panel-heading" align="left">
        <form class="form-inline">
            ...
            <div class="form-group">
                <a class="btn btn-primary" href="index.php?m=alternatif_tambah"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
            </div>
        </form>
    </div>
    <table class="table table-bordered table-hover table-striped">
        ...
        <?php
        $q = esc_field($_GET['q']);
        $rows = $db->get_results("SELECT * FROM tb_alternatif WHERE kode_alternatif LIKE '%$q%' OR nama_alternatif LIKE '%$q%' ORDER BY kode_alternatif ASC");
        $no = 0;
        foreach ($rows as $row) : ?>
            <tr>
                <td align="left"><?= ++$no ?></td>
                ...
                <td align="left"><?= $row->no_tlp ?></td>
                <td align="left">
                    <a class="btn btn-xs btn-warning" href="index.php?m=alternatif_ubah&ID=<?= $row->kode_alternatif ?>"><span class="glyphicon glyphicon-edit"></span></a>
