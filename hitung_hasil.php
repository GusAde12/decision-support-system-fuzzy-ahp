...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form method="post" action="simpantgl.php">
        <div class="form-group">
                    <label for="tanggal">Tanggal</label>
                    <input type="date" value="<?= $row->kode_alternatif ?>" <?= (in_array($row->kode_alternatif, $selected)) ? 'checked' : '' ?> class="form-control" name="tanggal">
                </div>
        ...
        <p><button type="submit" value="simpan">SIMPAN</button></p>
    </div>
