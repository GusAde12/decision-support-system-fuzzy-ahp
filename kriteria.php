...
<div class="panel panel-default">
    <div class="panel-heading" align="left">
        <form class="form-inline">
            ...
            <div class="form-group">
                <a class="btn btn-primary" href="index.php?m=kriteria_tambah"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
            </div>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <?php
        $q = esc_field($_GET['q']);
        $rows = $db->get_results("SELECT * FROM tb_kriteria WHERE nama_kriteria LIKE '%$q%' ORDER BY kode_kriteria ASC");
        $no = 0;
        foreach ($rows as $row) : ?>
            <tr align="left">
                <td><?= ++$no ?></td>
                ...
                <td>
                    <a class="btn btn-xs btn-warning" href="index.php?m=kriteria_ubah&ID=<?= $row->kode_kriteria ?>"><span class="glyphicon glyphicon-edit"></span></a>
