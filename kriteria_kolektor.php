...
<div class="panel panel-default">
    ...
    <div class="panel-heading" align="left">
        <form class="form-inline">
            ...
            <div class="form-group">
                <a class="btn btn-primary" href="index.php?m=kriteria_tambah_kolektor"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
            </div>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        foreach ($rows as $row) : ?>
            <tr align="left">
                ...
                <td>
                    <a class="btn btn-xs btn-warning" href="index.php?m=kriteria_ubah_kolektor&ID=<?= $row->kode_kriteria ?>"><span class="glyphicon glyphicon-edit"></span></a>
